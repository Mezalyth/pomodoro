...
>
	<div class="pomodoro-timer">
		...
		<div class="mode-buttons">
			<button on:click={() => setMode('Work')} class:active-mode={mode === 'Work'}
				>Pomodoro (Work)</button
			>
			<button on:click={() => setMode('Short Break')} class:active-mode={mode === 'Short Break'}
				>Short Break</button
			>
			<button on:click={() => setMode('Long Break')} class:active-mode={mode === 'Long Break'}
				>Long Break</button
			>
		</div>
		<!-- Timer Controls -->
