...
<div class="pomodoro-timer">
  ...
  <!-- Mode Change Buttons (still manual for override) -->
...
/* More specific selector for the active button */
.mode-buttons button.active-mode {
  background-color: #01956b; /* Blue background */
  color: #fff; /* White text */
  border-color: #01956b; /* Blue border */
}

.mode-buttons button.active-mode:hover {
  background-color: #006d4e; /* Darker blue on hover */
  border-color: #006d4e; /* Darker blue border on hover */
}
